...
function ResourcePattern({
  ...
  return (
    <div className="pointer-events-none">
      ...
      <motion.div
        className="absolute inset-0 rounded-2xl bg-gradient-to-r from-[#87a5d7] to-[#b1d1f7] opacity-0 transition duration-300 group-hover:opacity-100 dark:from-[#87a5d7] dark:to-[#b1d1f7]"
        style={style}
      />
      <motion.div
