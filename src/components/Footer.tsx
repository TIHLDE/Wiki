...
export function LinkedInIcon(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" {...props}>
      <path d="M19 3A2 2 0 0 1 21 5V19A2 2 0 0 1 19 21H5A2 2 0 0 1 3 19V5A2 2 0 0 1 5 3H19M5.07 18.28H7.62V10.3H5.07V18.28M6.34 8.96C7.37 8.96 8.18 8.16 8.18 7.13C8.18 6.1 7.37 5.31 6.34 5.31C5.31 5.31 4.5 6.1 4.5 7.13C4.5 8.16 5.31 8.96 6.34 8.96M8.92 18.28H11.47V13.45C11.47 11.7 12.88 10.3 14.62 10.3C16.37 10.3 17.77 11.7 17.77 13.45V18.28H20.32V12.8C20.32 10.07 18.17 7.93 15.45 7.93C13.97 7.93 12.68 8.74 12 10.06H11.97V10.3H8.92V18.28Z" />
    </svg>
  )
}
